            ...
            <div class="row no-gutters slider-text align-items-end justify-content-start">
                <div class="col-md-12 ftco-animate text-center mb-5">
                    <p class="breadcrumbs mb-0"><span class="mr-3"><a href="{{route('home')}}">Home
                                <i class="ion-ios-arrow-forward"></i></a></span> <span>Edit Newsletter</span></p>
                    <h1 class="mb-3 bread">Newsletter Edit</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-8 mb-5">
                    <form method="POST"
                        ...
                        <h3 class="h5 text-black mb-3" style="color: #fdab44;">Edit Newsletter</h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <textarea name="body" rows="6" class="form-control"
                                                  placeholder="Engaging content">{{ old('body', $newsletter->body) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row no-gutters mb-4">
                            ...
                            @else
                                <img id="preview-image" alt="No image uploaded">
                            @endif
                            <div class="col-md mr-md-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="text" name="cta_label"
                                               value="{{ old('cta_label', $newsletter->cta_label) }}"
                                               class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="url" name="cta_url"
                                               value="{{ old('cta_url', $newsletter->cta_url) }}"
                                               class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="datetime-local" name="send_at"
                                               value="{{ old('send_at', optional($newsletter->send_at)->format('Y-m-d\TH:i')) }}"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <select name="repeat_type" class="form-control">
                                            ...
                                            <option value="daily" {{ old('repeat_type', $newsletter->repeat_type) == 'daily' ? 'selected' : '' }}>Daily</option>
                                            <option value="weekly" {{ old('repeat_type', $newsletter->repeat_type) == 'weekly' ? 'selected' : '' }}>Weekly</option>
                                            <option value="monthly" {{ old('repeat_type', $newsletter->repeat_type) == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="number" min="1" name="repeat_interval"
                                               value="{{ old('repeat_interval', $newsletter->repeat_interval) }}"
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn custom-btn-wide">Update Newsletter</button>
                            </div>
                        </div>
                    </form>
                </div>
