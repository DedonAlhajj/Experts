            ...
            <div class="row no-gutters slider-text align-items-end justify-content-start">
                <div class="col-md-12 ftco-animate text-center mb-5">
                    <p class="breadcrumbs mb-0"><span class="mr-3"><a href="{{route('home')}}">Home
                                <i class="ion-ios-arrow-forward"></i></a></span> <span>Create Blog</span></p>
                    <h1 class="mb-3 bread">Blogs Create</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-8 mb-5">
                    <form method="POST" action="{{ route('blogs.store') }}" enctype="multipart/form-data" class="search-job p-5 bg-white">
                        @csrf

                        <h3 class="h5 text-black mb-3" style="color: #fdab44;">Blog Info</h3>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-field">
                                ...
                                <textarea name="summary" rows="3" class="form-control" placeholder="Short Summary">{{ old('summary') }}</textarea>
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="form-field">
                                ...
                                <textarea name="contentBlog" rows="6" class="form-control" placeholder="Full Blog Content">{{ old('contentBlog') }}</textarea>
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <label class="custom-upload">
                                <img src="{{asset('images/default.jpg')}}" id="preview-image" alt="Blog Cover"/>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 text-center">
                                <button type="submit" class="btn custom-btn-wide">Create Blog</button>
                            </div>
                        </div>
                    </form>
                </div>
